...
class EzxmlToDocbookTest extends BaseTest
{
    ...
    public function providerForTestConvert()
    {
        ...
        foreach ( glob( __DIR__ . "/_fixtures/*.xml" ) as $xmlFile )
        {
            $map[] = array(
                $xmlFile,
                __DIR__ . "/../../../../../../../../FieldType/Tests/RichText/Converter/Xslt/_fixtures/docbook/" . basename( $xmlFile )
            );
        }
    ...
    {
        return __DIR__ . "/../../../../../../Content/FieldValue/Converter/RichText/Resources/stylesheets/ezxml_docbook.xsl";
    }
    ...
    {
        return __DIR__ . "/../../../../../../../../FieldType/RichText/Resources/schemas/docbook/ezpublish.rng";
    }
}
