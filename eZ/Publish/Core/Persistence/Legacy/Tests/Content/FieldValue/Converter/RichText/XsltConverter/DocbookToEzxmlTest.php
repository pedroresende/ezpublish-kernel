...
class DocbookToEzxmlTest extends BaseTest
{
    ...
    public function providerForTestConvert()
    {
        ...
        foreach ( glob( __DIR__ . "/../../../../../../../../FieldType/Tests/RichText/Converter/Xslt/_fixtures/docbook/*.xml" ) as $xmlFile )
        {
            $map[] = array(
                $xmlFile,
    ...
    {
        return __DIR__ . "/../../../../../../Content/FieldValue/Converter/RichText/Resources/stylesheets/docbook_ezxml.xsl";
    }
    ...
    {
        return __DIR__ . "/../../../../../../Content/FieldValue/Converter/RichText/Resources/schemas/ezxml.xsd";
    }
}
