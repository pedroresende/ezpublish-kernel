...
class DocbookToXhtml5EditTest extends BaseTest
{
    ...
    {
        return __DIR__ . "/../../../../RichText/Resources/stylesheets/docbook/xhtml5/xhtml5.xsl";
    }
    ...
    protected function getCustomConversionTransformationStylesheets()
    {
        return array(
            array(
                "path" => __DIR__ . "/../../../../RichText/Resources/stylesheets/docbook/xhtml5/core.xsl",
                "priority" => 100
            ),
            array(
    ...
    {
        return __DIR__ . "/../../../../RichText/Resources/schemas/ezxhtml5/ezxhtml5.xsd";
    }
}
