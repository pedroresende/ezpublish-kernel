...
class LegacyStorageTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|\eZ\Publish\Core\FieldType\RichText\RichTextStorage\Gateway\LegacyStorage
     */
    protected function getPartlyMockedLegacyStorage( array $testMethods = null )
    {
        return $this->getMock( 'eZ\Publish\Core\FieldType\RichText\RichTextStorage\Gateway\LegacyStorage', $testMethods );
    }
