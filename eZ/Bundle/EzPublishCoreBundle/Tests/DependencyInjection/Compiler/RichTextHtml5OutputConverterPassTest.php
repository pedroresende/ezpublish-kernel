<?php
/**
 * File containing the RichTextHtml5OutputConverterPassTest class.
 *
...
class RichTextHtml5OutputConverterPassTest extends AbstractCompilerPassTest
{
    public function testProcess()
    {
        $container = new ContainerBuilder();
        $html5ConvertDef = new Definition();
        $container->setDefinition( 'ezpublish.fieldType.ezrichtext.converter.output.xhtml5', $html5ConvertDef );
        ...
        $pass = new RichTextHtml5OutputConverterPass();
    ...
    {
        $this->setDefinition( 'ezpublish.fieldType.ezrichtext.converter.output.xhtml5', new Definition() );
